...
# Generic combat encounter defaults. Individual Creature implementations may
# override the trigger distance and their own combat behavior.
BATTLE_TRIGGER_DISTANCE = 42.0
BATTLE_LOOK_SMOOTH_HZ = 5.5
...
# Compatibility names for older scene configuration.
GOBLIN_BATTLE_TRIGGER_DISTANCE = BATTLE_TRIGGER_DISTANCE
GOBLIN_BATTLE_LOOK_SMOOTH_HZ = BATTLE_LOOK_SMOOTH_HZ
